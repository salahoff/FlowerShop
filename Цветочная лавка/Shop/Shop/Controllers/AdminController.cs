...
namespace Shop.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(ProductService productService, OrderService orderService, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, ShopContext context)
        {
